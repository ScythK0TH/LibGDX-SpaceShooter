...
public class winScreen implements Screen {
    ...
    private Texture winBannner;
    private BitmapFont font12;
    public HighScore highScoreManager;

    public winScreen(final Main game, int score, GameTimer gameTimer) {
        this.game = game;
        this.score = score;
        ...
        winBannner = new Texture(Gdx.files.internal("winGame2.png"));
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(winBannner, Gdx.graphics.getWidth() / 2 - BANNER_WIDTH / 2, Gdx.graphics.getHeight() - BANNER_HEIGHT - 15, BANNER_WIDTH, BANNER_HEIGHT);
